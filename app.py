...
# writing text to 1st column
    ...
    # writing text to 2nd column
    col2.write("Interested in reselling, distributing our products, and other partnership or business opportunities, please contact us through: yashamr192@gmail.com")
